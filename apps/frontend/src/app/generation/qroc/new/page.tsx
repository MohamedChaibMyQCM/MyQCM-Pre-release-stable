...
const WIZARD_STEPS = [
  ...
  { title: "Configuration", description: "Set QROC parameters" },
...
export default function QROCAIWizardPage() {
  ...
  const [qrocCount, setQrocCount] = React.useState(10);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("QROC generation request created successfully!");
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight">
            AI-Powered QROC Generation
          </h1>
          <p className="text-muted-foreground">
            Upload a source document and let AI generate short answer questions automatically
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    max="100"
                    value={qrocCount}
                    onChange={(e) => setQrocCount(parseInt(e.target.value) || 10)}
                ...
                <div className="rounded-lg border bg-muted p-4">
                  ...
                  <ul className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <li>• Generate {qrocCount} short answer questions</li>
                ...
                <div className="rounded-lg border bg-muted p-4">
                  ...
                  <dl className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium">AI-Generated QROCs</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-muted-foreground">Quantity:</dt>
                      <dd className="font-medium">{qrocCount} questions</dd>
                    </div>
                    <div className="flex justify-between">
