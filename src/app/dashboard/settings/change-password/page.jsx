    ...
    <div className="mx-5 bg-[#FFFFFF] py-5 px-6 mt-12 rounded-[16px] box max-md:mt-4">
      ...
      <form className="mt-6">
        ...
        <div className="flex justify-between items-center mt-10 max-md:flex-col max-md:gap-6 max-md:mt-6">
          ...
          <button className="bg-[#F8589F] text-[#FFFFFF] px-5 py-2 rounded-[16px] text-[13px] font-[500] max-md:self-end">
            Save Changes
          </button>
        </div>
      </form>
      <Image src={password} alt="password" className="mx-auto mt-8 max-md:mt-10" />
    </div>
  );
};
