...
const Layout = ({ children }) => {
  return (
    <section className="h-[100vh] w-[100vw] overflow-hidden flex bg-[#FB63A6] p-[26px] px-[40px] max-xl:flex-col max-xl:items-center max-md:px-[20px] overflow-y-auto scrollbar-hide">
