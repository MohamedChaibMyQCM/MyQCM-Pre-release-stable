...
const Units = () => {
  return (
    <div className="relative w-[100%] p-6 py-4 rounded-[20px] overflow-hidden bg-gradient-to-r from-[#FD2E8A] to-[#F8589F] max-md:px-4">
      <div className="max-md:text-center">
        ...
        <p className="text-[13px] text-[#FFFFFF] mt-2 mb-5 font-[400]">
          ...
          and the psychological aspects of medical care. This unit <br className="max-md:hidden" />
