          ...
          return (
            ...
            >
              <div className="mb-5 flex justify-between items-start">
                <div className="flex items-center bg-[#FF95C4] w-fit py-[8px] px-[20px] rounded-[16px]">
                  <Image
                    src={item.university}
                    alt="university logo"
                    className="w-[36px]"
                  />
                  <span className="bg-[#FFFFFF] w-[1.6px] h-[40px] ml-[6px] mr-[10px] rounded-full"></span>
                  <Image src={item.module} alt="module" className="w-[28px]" />
                </div>
                <Image
                  src={options}
                  alt="options"
