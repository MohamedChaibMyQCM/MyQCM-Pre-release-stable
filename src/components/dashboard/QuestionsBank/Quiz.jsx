...
const Quiz = () => {
  return (
    <div className="bg-[#FFFFFF] w-[70%] rounded-[16px] mx-auto my-auto p-[20px] flex flex-col gap-6">
      ...
      <div className="flex gap-8">
        <div>
          <span className="block font-Poppins text-[#858494] text-[13px] font-medium mb-2">QUESTION 7 OF 68</span>
      ...
      <div className="self-end flex items-center gap-4">
        ...
        <button className="bg-[#FF6EAF] text-[#FFFFFF] font-Poppins font-medium text-[13px] px-[16px] py-[10px] rounded-[14px]">
          Check Answer
        </button>
      </div>
    </div>
