...
const Personal_Info = () => {
  return (
    <div className="mx-5">
      <div className="relative mt-8 bg-[#FFFFFF] rounded-[16px] overflow-hidden h-[180px] box max-md:h-[120px]">
        <Image
        ...
        <div className="flex items-center justify-between px-6 mt-[86px] max-md:mt-10">
          <div className="flex items-center gap-4">
            <Image src={avatar} alt="profile img" className="w-[70px] max-md:w-[60px]" />
            <div className="flex flex-col">
              <span className="text-[#191919] text-[15px] font-[500]">
                Rayane Boucheraine
              </span>
              <span className="text-[#B5BEC6] text-[14px]">
                Premium + AI account
              </span>
            </div>
          </div>
          <button className="flex items-center gap-1 border border-[#F8589F] px-3 py-[3px] rounded-[16px] h-fit cursor-pointer">
