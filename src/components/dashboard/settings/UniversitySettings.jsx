...
const UniversitySettings = ({ userData }) => {
  ...
  return (
    <div className="bg-[#FFFFFF] p-6 rounded-[16px] box">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
        ...
        {isEditing ? (
          ...
          <button
            ...
            className="flex items-center gap-1 border border-[#F8589F] px-3 py-[3px] rounded-[16px] h-fit"
          >
          ...
          <li className="flex flex-col gap-2 w-[540px] max-md:w-full">
            ...
            {isEditing ? (
              <input
                ...
                disabled
                className="w-full px-[20px] py-[6px] mt-2 rounded-[16px] outline-none border border-gray-300 text-[13px] text-[#191919] bg-gray-100 cursor-not-allowed"
              />
            ) : (
      ...
      {isEditing && (
        <div className="mt-6 text-[#666666] text-[13px]">
